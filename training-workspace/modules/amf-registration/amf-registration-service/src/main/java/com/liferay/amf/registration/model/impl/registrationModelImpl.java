...
import com.liferay.amf.registration.model.registrationModel;
import com.liferay.amf.registration.model.registrationSoap;
...
public class registrationModelImpl extends BaseModelImpl<registration>
	...
	public static final String ORDER_BY_JPQL = " ORDER BY registration.field1 ASC";
	public static final String ORDER_BY_SQL = " ORDER BY registration_registration.field1 ASC";
	public static final String DATA_SOURCE = "liferayDataSource";
	public static final String SESSION_FACTORY = "liferaySessionFactory";
	public static final String TX_MANAGER = "liferayTransactionManager";
	public static final boolean ENTITY_CACHE_ENABLED = GetterUtil.getBoolean(com.liferay.amf.registration.service.util.ServiceProps.get(
				"value.object.entity.cache.enabled.com.liferay.amf.registration.model.registration"),
			true);
	public static final boolean FINDER_CACHE_ENABLED = GetterUtil.getBoolean(com.liferay.amf.registration.service.util.ServiceProps.get(
				"value.object.finder.cache.enabled.com.liferay.amf.registration.model.registration"),
			true);
	public static final boolean COLUMN_BITMASK_ENABLED = GetterUtil.getBoolean(com.liferay.amf.registration.service.util.ServiceProps.get(
				"value.object.column.bitmask.enabled.com.liferay.amf.registration.model.registration"),
			true);
	...
	public static final long LOCK_EXPIRATION_TIME = GetterUtil.getLong(com.liferay.amf.registration.service.util.ServiceProps.get(
				"lock.expiration.time.com.liferay.amf.registration.model.registration"));
	...
	public Object clone() {
		...
		registrationImpl.setFooId(getFooId());
		...
		registrationImpl.setField1(getField1());
		registrationImpl.setField2(getField2());
		registrationImpl.setField3(getField3());
		registrationImpl.setField4(getField4());
		registrationImpl.setField5(getField5());
	...
	public int compareTo(registration registration) {
		...
		value = getField1().compareTo(registration.getField1());
	...
	public void resetOriginalValues() {
		...
		registrationModelImpl._originalField2 = registrationModelImpl._field2;

		registrationModelImpl._setOriginalField2 = false;
	...
	public CacheModel<registration> toCacheModel() {
		...
		registrationCacheModel.fooId = getFooId();
		...
		registrationCacheModel.field1 = getField1();

		String field1 = registrationCacheModel.field1;

		if ((field1 != null) && (field1.length() == 0)) {
			registrationCacheModel.field1 = null;
		}

		registrationCacheModel.field2 = getField2();

		registrationCacheModel.field3 = getField3();

		Date field4 = getField4();

		if (field4 != null) {
			registrationCacheModel.field4 = field4.getTime();
		}
		else {
			registrationCacheModel.field4 = Long.MIN_VALUE;
		}

		registrationCacheModel.field5 = getField5();

		String field5 = registrationCacheModel.field5;

		if ((field5 != null) && (field5.length() == 0)) {
			registrationCacheModel.field5 = null;
		}
	...
	public String toXmlString() {
		...
		sb.append("com.liferay.amf.registration.model.registration");
