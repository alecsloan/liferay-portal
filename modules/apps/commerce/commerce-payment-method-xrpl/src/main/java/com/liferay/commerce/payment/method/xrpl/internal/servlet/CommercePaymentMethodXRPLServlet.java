...
package com.liferay.commerce.payment.method.xrpl.internal.servlet;
...
@Component(
	immediate = true,
	property = {
		"osgi.http.whiteboard.context.path=/" + XRPLPaymentMethodConstants.SERVLET_PATH,
		"osgi.http.whiteboard.servlet.name=com.liferay.commerce.payment.method.xrpl.internal.servlet.CommercePaymentMethodXRPLServlet",
		"osgi.http.whiteboard.servlet.pattern=/" + XRPLPaymentMethodConstants.SERVLET_PATH + "/*"
	},
	service = Servlet.class
)
public class CommercePaymentMethodXRPLServlet extends HttpServlet {
	...
	private static final Log _log = LogFactoryUtil.getLog(
		CommercePaymentMethodXRPLServlet.class);
