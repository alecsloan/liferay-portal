...
@Component(
	enabled = false,
	service = {
		CPDefinitionAvailabilityInfoItemRenderer.class, InfoItemRenderer.class
	}
)
public class CPDefinitionAvailabilityInfoItemRenderer
	implements InfoItemRenderer<CPDefinition> {

	@Override
	public String getKey() {
		return "cpDefinition-availability";
	}
